...
namespace SocketCliente
{
    public partial class Form1 : Form
    {
        ...
        private void btnConectar_Click(object sender, EventArgs e)
        {
            try
            {
                //zona de algoritmo blowfish
                b12 = new ClaseBlowfish("04B915BA43FEB5B6");
                cipherText = b12.Encrypt_CBC(txtUsuario.Text);
                


                //zona de envio de informacion
                this.Text = string.Format("Cliente: {0}", cipherText);
                ...
                Byte[] datos = System.Text.Encoding.ASCII.GetBytes(cipherText + "$");
        ...
        private void btnEnviar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Byte[] datos = Encoding.ASCII.GetBytes(txtMensaje.Text + "$" + cipherText);
